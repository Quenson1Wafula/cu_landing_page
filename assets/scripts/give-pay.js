document.addEventListener("DOMContentLoaded", () => {
    const modalParenContainer = document.querySelector(".modal-container");
  const createDynamicModal = () => {
    // created modal container
    ...
    phoneNumberInput.placeholder = "07XXXXXXXX";
    ...
    const phoneNumberIconSvg = document.createElementNS(
    ...
    phoneNumberIconSvg.innerHTML =
      '<path d="M15.75,14.85l-2.54,2.53c-1.532-0.807-2.759-1.747-3.798-2.792c-1.045-1.039-1.985-2.266-2.792-3.798l2.53-2.54L8.512,3H3 c0,0,0,0.328,0,1c0,4.539,1.84,8.874,4.966,12.034C11.126,19.16,15.461,21,20,21c0.672,0,1,0,1,0v-5.512L15.75,14.85z"/></svg>';
    ...
    const amountIconSvg = document.createElementNS(
      "http://www.w3.org/2000/svg",
      "svg"
    );
    ...
    modalParenContainer.appendChild(modalDiv);
  };

  const modal_btn = document.querySelector(".btn-modal");
  modal_btn.addEventListener("click", () => {
    modalParenContainer.style.display = "block";
